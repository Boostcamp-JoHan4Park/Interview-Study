...
* [검정력(statistical power)은 무엇일까요?](#15)
...
대립가설이 사실일 때 이를 사실로써 결정할 확률. 귀무 가설을 올바르게 기각하는 확률입니다.



### #16

결측치의 개수에 따라 다른 것 같습니다.. 전체 데이터의 수에서 굉장히 적은 수라면 채우지 않고 지워도 될 것 같은데, 전체 데이터 수가 적다면 결측치를 다양한 방법(0, 평균, 이전값, 이후값)을 통해 채운 다음 사용하는 것이 맞는 것 같습니다.
